...
const handleDelete = (id: number) => {
  if (confirm('Do you want to delete a product')) {
    router.delete(route('academic.delete', { id }))
  }
}
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="container mx-auto px-4 py-6">
      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          <h1 class="text-2xl font-bold text-gray-800">Academic Management</h1>
          <p class="text-sm text-gray-500 mt-1">Manage all registered academic year in the system</p>
        </div>
        <Link :href="route('academic.create')"
        ...
        <div class="relative overflow-x-auto">
          <Table>
            <TableHeader class="bg-gray-50">
              <TableRow>
                <TableHead class="w-[200px]">Year Name</TableHead>
            ...
            <TableBody>
              <TableRow v-for="academic in props.academics" :key="academic.id"
                ...
                <TableCell>{{ academic.end_date }}</TableCell>
                <!-- <TableCell class="max-w-[200px] truncate" :title="academic.status">
                  {{ academic.status }}
                </TableCell> -->
                <TableCell class="max-w-[200px] truncate">
                  <label class="inline-flex items-center cursor-pointer">
                    <input type="checkbox" v-model="academic.status" true-value="active" false-value="inactive"
                      class="sr-only peer">
                    <div
                ...
                <TableCell>
                  <div class="flex justify-end gap-2">
                    <Link :href="route('academic.edit', academic.id)"
                    ...
                    <Button @click="handleDelete(academic.id)" variant="destructive" size="sm" class="gap-1">
